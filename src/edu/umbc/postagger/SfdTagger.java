...
public class SfdTagger {
	...
	public int startTaggingAndCounting(File textfile) throws IOException{
		...
		if ((paragraphs.modelName.contains("Gutenberg")) && !paragraphs.IsEnglish2(path)) {
			paragraphs.close();
			return -1;
		}
	...
	public static void main(String[] args) throws Exception {
		...
		*/
		...
		if (args.length == 1){
			test = new SfdTagger(args[0]);
			//test = new SfdTagger(dataPath+"/test/corpus/test2");
			test.run();
		}else {
