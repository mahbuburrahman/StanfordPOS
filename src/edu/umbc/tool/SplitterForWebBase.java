...
public class SplitterForWebBase {
	...
	public SplitterForWebBase(String directoryName) {
		...
		//textfile = new File(dataPath1+"/corpus/webbase/text-2007-02/university+publication/utexas_iit.pages");
	...
	public static void main(String[] args) throws IOException {
		...
		SplitterForWebBase splitter = new SplitterForWebBase(dataPath1+"/corpus/webbase/text-2007-02/university+publication/");
